...
\rightposterlogo{images/impatex_png.png}    % logo à direita
\begin{document}

% largura e altura de cada logo
\leftlogosize{20cm}{20cm}
\rightlogosize{12cm}{8cm}
...
\begin{postercard}[beige,white,black,black, black]{Experimentos}
Este é um exemplo de seção usando a classe ImpaTeXPoster.
...
\begin{postercard}[beige,white,black,black, black]{Resultados}
Mostrar como usar diferentes cores no ambiente.
...
\begin{postercard}[beige,white,black,black,black]{Conclusão}
\lipsum[4]
\end{postercard}

\begin{postercard}[beige,white,black,black,black]{Trabalhos futuros}
\lipsum[3]
\end{postercard}

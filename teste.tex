...
\posterlogo{images/impatech.png}
\rightposterlogo{images/tex.png} % Logo do evento, caso houver
...
\plainblock{
    \centering
    \includegraphics[width=0.9\linewidth]{images/lora.png}
...
\plainblock{
    \centering
    \includegraphics[width=0.9\linewidth]{images/llm.jpg}
